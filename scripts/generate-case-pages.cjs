...
<header class="site-head">
  <div class="wrap head-inner">
    <a class="brand brand-link" href="/"><img class="brand-mark" src="/assets/img/brand/memecoin-heatmap-mark.png" alt="" width="44" height="44" decoding="async"><div><h1>Memecoin Heatmap</h1><p class="brand-sub">Sourced memecoin case study</p></div></a>
...
<main class="wrap article-wrap" id="article">
  ...
  <header class="token-hero">
    <img class="token-logo" id="tokenLogo" src="${item.logo}" alt="${item.name} logo" width="96" height="96" decoding="async">
  ...
  <section class="panel case-story-panel">
    <div class="case-story-grid">
      <article class="article-body" id="articleBody"><h2>Launch and market path</h2></article>
      <aside class="case-analysis">
        <div><h3>Narrative</h3><p id="caseNarrative"></p></div>
        <div><h3>Why it crossed $100M</h3><p id="caseCrossingReason"></p></div>
      </aside>
    </div>
  </section>
